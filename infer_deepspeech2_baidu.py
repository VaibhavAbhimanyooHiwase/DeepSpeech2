...
# yapf: disable
add_arg('num_samples',      int,    20000,     "# of samples to infer.")
    ...
    for target, result, audio_file_path in zip(target_transcripts, result_transcripts, audio_file_paths):
        ...
        json_lines.append(
                    json.dumps({
                        ...
                        'Current {} error rate'.format(args.error_rate_type): error_rate_func(target, result),
        ...
        with codecs.open('transcription.json', 'w', 'utf-8') as out_file:
            for line in json_lines:
                out_file.write(line + '\n')
...
#        audio_path = '/home/vaibhav/Documents/DeepSpeech-develop/test_dataset/vaibhav_data_test_wav16k/Open-Patient-Register1580210654.wav'
        main(audio_path)
    else:
        main()
